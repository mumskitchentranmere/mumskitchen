...
// Returns the ESC/POS receipt as a hex string.
// The client (browser) forwards this to the local printer-bridge running on
// the restaurant computer, which handles the TCP connection to the printer.

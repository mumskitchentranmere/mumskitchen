...
import { ShoppingBag, User, Clock, Star, PenLine } from 'lucide-react';
      ...
      <div style={{ background:'var(--brown-dark)', padding:'40px 24px' }}>
        <div style={{ maxWidth:'900px', margin:'0 auto' }}>
          ...
          <div style={{ display:'flex', gap:'12px', marginTop:'20px', flexWrap:'wrap' }}>
            {[['Orders', orders.length, '#3b82f6'], ['Reviews', myReviews.length, '#C8922A']].map(([l,v,c])=>(
            ...
            {orders.length === 0 ? (
              ...
              <div key={o._id} style={{ background:'white', borderRadius:'14px', padding:'16px', border:'1px solid var(--stone-light)', display:'flex', justifyContent:'space-between', alignItems:'center', flexWrap:'wrap', gap:'8px' }}>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
                  <span style={{ fontSize:'12px', background:'var(--stone-light)', color:'var(--brown-mid)', padding:'3px 8px', borderRadius:'8px' }}>🥡 Takeaway</span>
